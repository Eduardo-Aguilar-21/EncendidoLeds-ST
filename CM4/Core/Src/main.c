...
/* USER CODE BEGIN PV */
int State = 0;
#define LED_PIN_1 GPIO_PIN_15  // Define el pin para el LED 1
#define LED_PIN_2 GPIO_PIN_9 // Define el pin para el LED 2
#define LED_PIN_3 GPIO_PIN_11 // De
/* USER CODE END PV */
...
int main(void)
{
  ...
  {
	  /*
	  HAL_GPIO_WritePin(GPIOB, LED_PIN_1, GPIO_PIN_SET);
	  HAL_Delay(1000);
